...
<head>
    ...
    <meta name="description"
          content="Bunter Block ist ein Zusammenschluss von jungen Familien und Freunden, die beschlossen haben ihre Ideale und Ziele in einem gemeinsamen Wohnprojekt umzusetzen.">
    <meta name="keywords" content="">
    <script src="https://analytics.bunter-block.org/piwik.js" async=""></script>
...
<main role="main" class="container mb-5">
    ...
    <p>Verantwortliche Stelle im Sinne der Datenschutzgesetze, insbesondere der EU-Datenschutzgrundverordnung (DSGVO),
        ist:</p>
    <h3>Bunter Block eG &nbsp;|&nbsp;Bertramstraße 45 |&nbsp;44791 Bochum</h3>
    <p>&nbsp;</p>
    ...
    <p>Die Daten werden gelöscht, sobald diese für den Zweck der Erhebung nicht mehr erforderlich sind. Dies ist für die
        Daten, die der Bereitstellung der Webseite dienen, grundsätzlich der Fall, wenn die jeweilige Sitzung beendet
        ist.</p>
    ...
    <p>Natürlich können Sie unsere Website grundsätzlich auch ohne Cookies betrachten. Internet-Browser sind regelmäßig
        ...
        über die Einstellungen Ihres Browsers deaktivieren. Bitte verwenden Sie die Hilfefunktionen Ihres
        Internetbrowsers, um zu erfahren, wie Sie diese Einstellungen ändern können. Bitte beachten Sie, dass einzelne
        Funktionen unserer Website möglicherweise nicht funktionieren, wenn Sie die Verwendung von Cookies deaktiviert
        haben.</p>
    ...
    <p><em>Dient dazu, ständige Neu-Anmeldungen für eingeloggte Benutzer zu verhindern. (Speicherung erfolgt nur während
        der Benutzung)</em></p>
    <p><em>Diese Cookies nutzen wir, um anonymisierte Daten über die Nutzung unser Seite sehen zu können (Gültigkeit: 1
        Tag) und dabei wiederkehrende Benutzer zu erkennen. (Gültigkeit: 1 Jahr) Details hierzu können dem Abschnitt zum
        Thema Matomo entnommen werden. Die von uns gesammelten Daten werden nicht an andere Unternehmen weitergeleitet
        und verbleiben in verschlüsselter Form auf unserem eigenen Server.</em></p>
    <p><strong>piwik_PHP</strong></p>
    <p><em>Hierüber können wir besondere Funktionen (z.B. Animationen) mit Ihrem&nbsp;Browser steuern und so die Optik
        und Bedienung für den Nutzer verbessern.</em></p>
    <p>Soweit diese Cookies (auch) personenbezogene Daten betreffen können, informieren wir Sie darüber in den folgenden
        Abschnitten.</p>
    <p>Sie können über Ihre Browsereinstellungen einzelne Cookies oder den gesamten Cookie-Bestand löschen. Darüber
        hinaus erhalten Sie Informationen und Anleitungen, wie diese Cookies gelöscht oder deren Speicherung vorab
    ...
    <h3>Newsletter</h3>
    <h4>Art und Zweck der Verarbeitung:</h4>
    <p>Ihre Daten werden ausschließlich dazu verwendet, Ihnen den abonnierten Newsletter per E-Mail zuzustellen. Die
        Angabe Ihres Namens erfolgt, um Sie im Newsletter persönlich ansprechen zu können und ggf. zu identifizieren,
        falls Sie von Ihren Rechten als Betroffener Gebrauch machen wollen.</p>
    <p>Für den Empfang des Newsletters ist die Angabe Ihrer E-Mail-Adresse ausreichend. Bei der Anmeldung zum Bezug
        unseres Newsletters werden die von Ihnen angegebenen Daten ausschließlich für diesen Zweck verwendet. Abonnenten
        können auch über Umstände per E-Mail informiert werden, die für den Dienst oder die Registrierung relevant sind
        (bspw. Änderungen des Newsletterangebots oder technische Gegebenheiten).</p>
    <p>Für eine wirksame Registrierung benötigen wir eine valide E-Mail-Adresse. Um zu überprüfen, dass eine Anmeldung
        ...
        Newsletterversand verwendet und nicht an Dritte weitergegeben.</p>
    <h4>Rechtsgrundlage:</h4>
    ...
    <h4>Art und Zweck der Verarbeitung:</h4>
    <p>Diese Website benutzt Matomo (ehemals Piwik), eine Open-Source-Software zur statistischen Auswertung von
        Besucherzugriffen. Anbieter der Software Matomo ist die InnoCraft Ltd., 150 Willis St, 6011 Wellington,
        Neuseeland.</p>
    <p>Matomo verwendet sog. Cookies, also Textdateien, die auf Ihrem Computer gespeichert werden und die eine Analyse
        der Benutzung der Website durch Sie ermöglichen.</p>
    <p>Die durch das Cookie erzeugten Informationen über Ihre Nutzung des Internetangebotes werden auf einem Server in
        Deutschland gespeichert.</p>
    <p>Die IP-Adresse wird unmittelbar nach der Verarbeitung und vor deren Speicherung anonymisiert. Sie haben die
    ...
    <p>Nähere Informationen zu den Privatsphäre-Einstellungen der Matomo Software finden Sie unter folgendem Link: <a
            href="https://matomo.org/docs/privacy/" target="_blank" rel="nofollow noopener"><em>https://matomo.org/docs/privacy/</em></a><em>.</em>
    </p>
    <h4>Rechtsgrundlage:</h4>
    ...
    <h4>Bereitstellung vorgeschrieben oder erforderlich:</h4>
    <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein auf Basis Ihrer Einwilligung. Sofern
        Sie den Zugriff unterbinden, kann es hierdurch zu Funktionseinschränkungen auf der Website kommen.</p>
    ...
    <p>Sie können die Speicherung der Cookies durch eine entsprechende Einstellung Ihrer Browser-Software verhindern;
        ...
        Website vollumfänglich werden nutzen können.</p>
    <h4>Profiling:</h4>
    <p>Mit Hilfe des Tracking-Tools Matomo kann das Verhalten der Besucher der Webseite bewertet und die Interessen
        analysiert werden. Hierzu erstellen wir ein pseudonymes Nutzerprofil.</p>
    ...
    <h4>Bereitstellung vorgeschrieben oder erforderlich:</h4>
    <p>Die Bereitstellung der personenbezogenen Daten ist weder gesetzlich, noch vertraglich vorgeschrieben. Allerdings
        kann ohne die korrekte Darstellung der Inhalte von Standardschriften nicht ermöglicht werden.</p>
    <h4>Widerruf der Einwilligung:</h4>
    <p>Zur Darstellung der Inhalte wird regelmäßig die Programmiersprache JavaScript verwendet. Sie können der
        ...
        oder einen Einbindung JavaScript-Blocker installieren. Bitte beachten Sie, dass es hierdurch zu
    ...
    <h5>Bunter Block eG | &#100;&#97;&#116;&#x65;&#110;&#x73;&#x63;&#104;&#117;&#116;&#122;&#64;&#98;&#x75;&#x6E;&#116;&#x65;&#114;&#45;&#98;&#108;&#x6F;&#x63;&#107;&#46;&#x6F;&#x72;&#x67;</h5>

</main>

    <!-- Footer -->
    <footer class="page-footer font-small mt-5" id="footer">
        <div id="punkte-container">
            <img id="punkte" src="img/punkte.gif" class="img-fluid" alt="Punktewolke"/>
        </div>
        <div class="row" id="sitemap">
            ...
            <div class="col-md-2 col-5 mt-4 mb-4 mr-4">
                <h4>Partner</h4>
                <a href="https://www.stiftung-trias.de/" target="_blank" rel="noopener noreferrer">Stiftung
                    trias</a></br>
                <a href="https://www.gls.de/" target="_blank" rel="noopener noreferrer">GLS Bank</a></br>
            </div>
            <div class="col-md-2 col-6 mt-4 mb-4">
                <h4>Mehr Partner</h4>
                <a href="https://www.wbb-nrw.de/" target="_blank" rel="noopener noreferrer">Wohnbund NRW</a></br>
                <a href="https://lunatic-circus.de/" target="_blank" rel="noopener noreferrer">Lunatic Circus</a>
            </div>
